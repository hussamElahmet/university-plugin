...
$css_styles .= "@media screen and (min-width: 782px){
    .block-editor .edit-post-header,.auto-fold .edit-post-header,.block-editor .components-notice-list {
      left: $guttenberg_header_width;
    }
  }";
  if(empty($this->aof_options['default_adminbar_height'])) {
    $css_styles .= '@media screen and (min-width: 782px){
      .edit-post-header,.block-editor .edit-post-header,.woocommerce-layout__header {
          top: 50px!important;
      }
