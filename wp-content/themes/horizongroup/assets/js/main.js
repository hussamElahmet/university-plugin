(function ($) {
    ...
    $(".language-wrap").on("click", function() {
        // $(this).parent().find('.languages , .search-content').slideToggle('medium');
        $('.languages').slideToggle();
    })
    
    var soonu_slider = new Swiper('.soonu-slider', {
        centeredSlides: true,
        slidesPerView: 1,
        spaceBetween: 40,
        loop: true,
        ...
        navigation: {
            nextEl: '.soonu-slider-next',
            prevEl: '.soonu-slider-prev',
        },
        breakpoints: {
            900: {
              slidesPerView: 3,
